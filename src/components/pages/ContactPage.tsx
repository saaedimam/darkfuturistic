      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl text-white mb-4 font-outfit">
            Let's Build{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4CAF50] to-[#66BB6A]">Together</span>
          </h1>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-inter">
            Ready to transform your business with innovative software solutions? Let's discuss how we can build systems
            that compound value for your organization.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {contactMethods.map((method, index) => (
            <Card
              key={index}
              className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 p-8 hover:bg-slate-800/70 transition-all duration-300 text-center"
            >
              <div
              ...
              <Button
                ...
                onClick={() => handleExternalLink(method.action)}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-slate-700/30 rounded-lg border border-slate-600/30">
                ...
                <p className="text-slate-300 font-inter">
                  Working with clients globally, with extensive experience in USA and Canadian markets through textile
                  export operations.
                </p>
              </div>
              ...
              <div className="p-4 bg-slate-700/30 rounded-lg border border-slate-600/30">
                ...
                <p className="text-slate-300 font-inter">
                  Experienced in remote project management and global team coordination. Comfortable working across time
                  zones.
                </p>
              </div>
            </div>
          ...
          <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 p-8">
            ...
            <div className="mt-6 p-4 bg-slate-700/30 rounded-lg border border-slate-600/30">
              <p className="text-slate-300 font-inter">
                <strong className="text-white">Urgent Projects:</strong> Available for emergency consultations and
                critical system issues outside regular hours.
              </p>
            </div>
          </Card>
        </div>
        ...
        <Card className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm border-slate-600/50 p-8 text-center">
          ...
          <p className="text-slate-300 font-inter mb-8 max-w-2xl mx-auto">
            Whether you need a complete digital transformation, RFID integration, or a custom SaaS solution, let's
            discuss how we can build systems that drive real business value.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              onClick={() => handleExternalLink("mailto:sayedimam.fahim@gmail.com?subject=Project Discussion")}
            >
            ...
            <Button
              variant="outline"
              className="border-[#FF7F3F] text-[#FF7F3F] hover:bg-[#FF7F3F]/10 px-8 py-6 rounded-xl font-inter bg-transparent"
              onClick={() =>
                handleExternalLink(
                  "https://wa.me/8801729809879?text=Hi%20Saaed,%20I%27d%20like%20to%20discuss%20a%20project",
                )
              }
            >
